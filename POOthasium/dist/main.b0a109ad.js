...
function (_super) {
  ...
  PlayScene.prototype.create = function () {
    ...
    this.enemy2 = enemy.get(200, 300, 'enemy').setCircle(10).setOffset(6);
...
function (_super) {
  ...
  poop.prototype.preUpdate = function (time, delta) {
    ...
    if (this.scene.physics.collide(this, this.scene.enemy)) {
      this.setVisible(false), this.setActive(false), this.scene.sound.play("splet2"), this.scene.enemy.setActive(false), this.scene.enemy.setVisible(false);
    }

    if (this.scene.physics.collide(this, this.scene.enemy2)) {
      this.setVisible(false), this.setActive(false), this.scene.sound.play("splet2"), this.scene.enemy2.setActive(false), this.scene.enemy2.setVisible(false);
    }
...
function (_super) {
  ...
  enemys.prototype.destroy = function (fromScene) {
    this.moveEvent.destroy(), _super.prototype.destroy.call(this, fromScene);
  };
  ...
  enemys.prototype.preUpdate = function (t, dt) {
    ...
    if (this.scene.physics.overlap(this.scene.scan, this.scene.player)) {
      this.enemythrow.paused = false, this.direction = 8;
    }

    if (this.scene.physics.overlap(this.scene.scan2, this.scene.player)) {
      this.enemythrow2.paused = false, this.direction = 8;
    }
